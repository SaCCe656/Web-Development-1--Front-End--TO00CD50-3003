...
WS02_JS_basics/ ├── index.html └── js/ └── script.js
...
const name = "John"; let age = 25; const favouriteAnimal = "Red Panda";
...
Submission
Complete the exercises in your WS02_JS_basics folder.
Commit and push your changes to GitHub.
Make sure the files are visible in your GitHub repository.
Submit the link to your repository in Canvas.